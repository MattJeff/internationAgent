# Le plugin Claude Code — l'interface par-dessus les 147 outils

Le serveur MCP (`docs/MCP_SERVEUR.md`) rend 147 outils. Brancher une URL et une
clé donne 147 verbes bruts et aucun mode d'emploi : le modèle doit deviner
...
les 147 lignes du registre sont éditées par d'autres chantiers, et un outil
