# Le plugin Claude Code — l'interface par-dessus les 139 outils

Le serveur MCP (`docs/MCP_SERVEUR.md`) rend 139 outils. Brancher une URL et une
clé donne 139 verbes bruts et aucun mode d'emploi : le modèle doit deviner
...
les 139 lignes du registre sont éditées par d'autres chantiers, et un outil
