# Le plugin Claude Code — l'interface par-dessus les 136 outils

Le serveur MCP (`docs/MCP_SERVEUR.md`) rend 136 outils. Brancher une URL et une
clé donne 136 verbes bruts et aucun mode d'emploi : le modèle doit deviner
...
les 136 lignes du registre sont éditées par d'autres chantiers, et un outil
